...
_Google does things a little differently..._
...
In particular, citizen journalism website Bellincat has made use of Google Earth Engine to do detailed environmental analysis, as well as using geospatial data more generally to support its wider work detailing human rights abuses in conflicts such as the war in Yemen.

In 2020, Bellingcat released data illustrating the fast decline of water levels in the Quitobaquito Springs on the US-Mexico border, making  use of Google Earth Engine data to access, filter and analyse satellite data of the springs. The journalists pointed to the open-source nature and ease of use of the programme as a key benefit.
